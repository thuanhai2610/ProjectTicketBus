                ...
                <div className="w-full grid grid-cols-5 gap-8">
                    ...
                    <div className="col-span-1 space-y-5">
                        ...
                        <div className="space-y-5">
                            <Link to="/help" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>Help Center</Link>
                            <Link to="/contact" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>Contact Us</Link>
                            <Link to="/faq" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>FAQs</Link>
                            <Link to="/support" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>Support Ticket</Link>
                        </div>
                    </div>
                    ...
                    <div className="col-span-1 space-y-5 ">
                        ...
                        <div className="space-y-5">
                            <Link to="/about" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>About Us</Link>
                            <Link to="/careers" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>Careers</Link>
                            <Link to="/news" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>News & Press</Link>
                            <Link to="/terms" className='block text-neutral-500 hover:text-neutral-300 font-normal ease-in-out duration-300'>Terms & Conditions</Link>
                        </div>
                    </div>
